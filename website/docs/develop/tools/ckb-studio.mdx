...
<img src={useBaseUrl("img/tools/ckb-studio/main.png")} width="80%" />
...
- [CKB Node Manager](#ckb-node-manager) - run CKB node and miner; switch between local, Pudge testnet and the CKB mainnet
...
<img src={useBaseUrl("img/tools/ckb-studio/welcome.png")} width="800px" />
...
<img src={useBaseUrl("img/tools/ckb-studio/create_project.png")} width="800px" />
...
<img src={useBaseUrl("img/tools/ckb-studio/build_button.png")} width="200px" />

There is an extra step before building a JavaScript project. You will need to type the command `npm install` or `yarn` manually in the terminal to install the project dependencies.

<img src={useBaseUrl("img/tools/ckb-studio/yarn.png")} width="800px" />
...
<img src={useBaseUrl("img/tools/ckb-studio/debug_button.png")} width="200px" />
...
<img src={useBaseUrl("img/tools/ckb-studio/debug_failed.png")} width="800px" />
...
<img src={useBaseUrl("img/tools/ckb-studio/keypair_manager.png")} width="800px" />
...
<img src={useBaseUrl("img/tools/ckb-studio/node_list_empty.png")} width="800px" />
...
<img src={useBaseUrl("img/tools/ckb-studio/create_node_instance.png")} width="800px" />
...
<img src={useBaseUrl("img/tools/ckb-studio/start_node_instance.png")} width="800px" />

#### Switch Networks

In the *Network* dropdown menu you can switch to other networks such as the **Pudge** testnet or the CKB mainnet. Switching the network will stop your currently running instance.

<img src={useBaseUrl("img/tools/ckb-studio/switch_network.png")} width="800px" />

### CKB Explorer

In the *Explorer* tab, you can look at basic account information and transaction history.

<img src={useBaseUrl("img/tools/ckb-studio/explorer.png")} width="800px" />
...
<img src={useBaseUrl("img/tools/ckb-studio/tx_constructor.png")} width="800px" />

#### Cell Explorer

Cells are the fundamental elements to form CKB transactions. The bottom half of the interface is a *cell explorer* where you can look through available cells (live cells) for each address. To learn more about CKB cells, please refer to the <Link to={useBaseUrl('/docs/basics/concepts/cell-model')}>cell model</Link>.
...
<img src={useBaseUrl("img/tools/ckb-studio/sign_transaction.png")} width="800px" />
...
<img src={useBaseUrl("img/tools/ckb-studio/transfer_transaction.png")} width="800px" />
